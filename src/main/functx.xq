...
declare default function namespace "my://sample/other/namespace/someOtherNamespace";

(:~
I'm a variable
:)
declare variable $functx:var := 'var';
...
($arg1 as xs:boolean?, $arg2 as xs:boolean?) as xs:boolean? {
